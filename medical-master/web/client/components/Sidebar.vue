        ...
        <div class="leftpanelinner">
         ...
         <admin-widget></admin-widget>
          ...
          <ul class="nav nav-tabs nav-justified nav-sidebar">
            ...
            <li class="tooltips" data-toggle="tooltip" title="Log Out"><router-link to="/signin"><i class="fa fa-sign-out"></i></router-link></li>
          </ul>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane active" id="mainmenu">
              <h5 class="sidebar-title">Tổng Quan</h5>
              <ul class="nav nav-pills nav-stacked nav-quirk">
                <li><a href="index.html"><i class="fa fa-home"></i> <span>Bảng Tin</span></a></li>
                <li><a href="widgets.html"><span class="badge pull-right">10+</span><i class="fa fa-cube"></i> <span>Kho Hàng</span></a></li>
                <li><a href="maps.html"><i class="fa fa-map-marker"></i> <span>Kinh Doanh</span></a></li>
              </ul>

              <h5 class="sidebar-title">Bảng Chọn</h5>
              <ul class="nav nav-pills nav-stacked nav-quirk">
                <li class="nav-parent">
                  <a href=""><i class="fa fa-check-square"></i> <span>Sản Phẩm</span></a>
                  <ul class="children">
                ...
                <li class="nav-parent"><a href=""><i class="fa fa-suitcase"></i> <span>Cửa Hàng</span></a>
                  <ul class="children">
                ...
                <li class="nav-parent active"><a href=""><i class="fa fa-file-text"></i> <span>Kế Hoạch</span></a>
                  <ul class="children">
                ...
                <li class="nav-parent"><a href=""><i class="fa fa-th-list"></i> <span>Thống Kê</span></a>
                  <ul class="children">
                ...
                <li class="media">
                  <a href="#">
                    <div class="media-left">
                      <img class="media-object img-circle" src="https://www.onlinewebfonts.com/style/user.png" alt="">
                    </div>
